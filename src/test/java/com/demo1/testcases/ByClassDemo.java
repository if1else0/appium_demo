...
public class ByClassDemo {
    ...
    public void demo() throws InterruptedException {
        Thread.sleep(20000);
//        ( (WebElement) driver.findElements(By.className("android.widget.TextView")).get(1)).click();
//        driver.findElement(By.className(""));
//        driver.findElementsByClassName("")
        System.out.println(driver.findElementById("com.netease.newsreader.activity:id/title").getText().toString());
